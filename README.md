...
[![Travis CI](https://travis-ci.org/jonpugh/g1astartertest.svg?branch=master)](https://travis-ci.org/jonpugh/g1astartertest)
[![Windows CI](https://ci.appveyor.com/api/projects/status/{{PUT_APPVEYOR_STATUS_BADGE_ID_HERE}}?svg=true)](https://ci.appveyor.com/project/jonpugh/g1astartertest)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/jonpugh/g1astartertest/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/jonpugh/g1astartertest/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/jonpugh/g1astartertest/badge.svg?branch=master)](https://coveralls.io/github/jonpugh/g1astartertest?branch=master) 
...
[![License](https://poser.pugx.org/jonpugh/g1astartertest/license)](https://github.com/jonpugh/g1astartertest//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/jonpugh/g1astartertest)
| Linux permutation testing | [DONE](https://travis-ci.org/jonpugh/g1astartertest)
...
- [GitHub issue templates](https://github.com/jonpugh/g1astartertest/issues/templates/edit)
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [releases](https://github.com/jonpugh/g1astartertest/releases) page.

## Authors

* **Jon Pugh** - created project from template.

See also the list of [contributors](https://github.com/jonpugh/g1astartertest/contributors) who participated in this project.
